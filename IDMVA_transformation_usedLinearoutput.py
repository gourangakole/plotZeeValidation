...
transfName   = ["trasfheedown","trasfheeup","trasfhebdown","trasfhebup"] # idmvaup_cat0_DYToEE
plotNameNominal = ["idmva_cat1_DYToEE","idmva_cat1_DYToEE","idmva_cat0_DYToEE","idmva_cat0_DYToEE"]
plotNameVariation   = ["idmvadown_cat1_DYToEE","idmvaup_cat1_DYToEE","idmvadown_cat0_DYToEE","idmvaup_cat0_DYToEE"]
...
def makeTransformation():
    ...
    out = ROOT.TFile("transformation_IDMVA_Moriond17_usedLinearoutput.root", "recreate")
    for g in graphs:
        g.Write()
    out.Close()
    print "wrote transformation_IDMVA_Moriond17_usedLinearoutput.root"
